<< EE 122 Spring 2015 Project #3 README >>
...
./source ROUTERADDR ROUTERPORT SERVICEDELAY SENDERID DESTADDR DESTPORT PACKETCOUNT MODE
...
MODE: 0 - Step 1; 1 - Step 2

e.g. ./source 127.0.0.1 5000 10 1 127.0.0.1 6000 500 1
...
To send 500 packets
Using mode 1 (Step 2 of project 3, which implements AIMD)